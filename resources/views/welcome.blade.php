...
<body class="bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-500 min-h-screen flex flex-col">
    ...
    <!-- Navbar -->
    <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow transition-colors duration-500">
    ...
    <!-- Hero Section -->
    <main class="flex-grow bg-blue-50 dark:bg-gray-900 py-24 transition-colors duration-500">
        <div class="max-w-4xl mx-auto text-center px-4">
            <h1 class="text-4xl md:text-5xl font-bold text-blue-800 dark:text-blue-400 transition-colors">Welcome to RAS Medical Clinic</h1>
            <p class="mt-4 text-lg text-gray-700 dark:text-gray-300 transition-colors max-w-xl mx-auto">
            ...
            <div class="mt-8 space-x-4">
                ...
                <a href="#" class="px-6 py-3 border border-blue-600 text-blue-600 rounded hover:bg-blue-100 dark:border-blue-400 dark:text-blue-300 dark:hover:bg-gray-700 transition-colors inline-block">
                    Learn More
                </a>
            </div>
        </div>
    ...
    <!-- Footer -->
    <footer class="bg-white dark:bg-gray-800 text-center text-sm text-gray-500 dark:text-gray-400 py-6 border-t border-gray-200 dark:border-gray-700 transition-colors duration-500">
