...
<body
    ...
    <main class="flex-grow py-16 px-4">
        <div
            class="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-10 max-w-2xl w-full mx-auto transition-colors duration-500">
            <h1 class="text-4xl font-extrabold mb-8 text-blue-700 dark:text-blue-400 text-center">Contact Us</h1>
            ...
            <div class="space-y-8 text-lg">
                <div class="flex items-center space-x-4">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-7 h-7 text-blue-600 dark:text-blue-400 flex-shrink-0" fill="none"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="mailto:clinictest@algonquinlive.com"
